...
giturl = 'https://github.com/{group}/{repository}'
call_trees_url = f'https://api.github.com/repos/{group}/{repository}/git/trees/main?recursive=1'
raw = f'https://raw.githubusercontent.com/{group}/{repository}/master/'
